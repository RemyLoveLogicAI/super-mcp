...
tags: ["impact", "changes", "dependencies"]
---
...
Analyze the impact of proposed changes across the codebase.

## Description

Impact Analysis is a canonical Super-MCP skill that provides structured, repeatable capability for analyze the impact of proposed changes across the codebase. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke impact-analysis --request "Describe what you need"
```

### With Context

```
invoke impact-analysis --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
