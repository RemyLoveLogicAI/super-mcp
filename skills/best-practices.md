...
tags: ["best-practices", "standards", "patterns"]
---
...
Research and compile best practices for specific technologies or domains.

## Description

Best Practices Finder is a canonical Super-MCP skill that provides structured, repeatable capability for research and compile best practices for specific technologies or domains. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke best-practices --request "Describe what you need"
```

### With Context

```
invoke best-practices --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
