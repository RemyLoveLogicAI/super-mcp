...
tags: ["validate", "schema", "constraints"]
---
...
Validate data against schemas, business rules, and constraints.

## Description

Data Validation is a canonical Super-MCP skill that provides structured, repeatable capability for validate data against schemas, business rules, and constraints. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke data-validation --request "Describe what you need"
```

### With Context

```
invoke data-validation --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
