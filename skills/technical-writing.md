...
Write clear technical documentation, guides, and specifications.

## Description

Technical Writing is a canonical Super-MCP skill that provides structured, repeatable capability for write clear technical documentation, guides, and specifications. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke technical-writing --request "Describe what you need"
```

### With Context

```
invoke technical-writing --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
