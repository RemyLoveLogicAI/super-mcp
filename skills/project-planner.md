...
Create project plans with milestones, tasks, dependencies, and timelines.

## Description

Project Planner is a canonical Super-MCP skill that provides structured, repeatable capability for create project plans with milestones, tasks, dependencies, and timelines. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke project-planner --request "Describe what you need"
```

### With Context

```
invoke project-planner --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
