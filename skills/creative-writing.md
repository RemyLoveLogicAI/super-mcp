...
Generate creative fiction, poetry, and narrative content.

## Description

Creative Writing is a canonical Super-MCP skill that provides structured, repeatable capability for generate creative fiction, poetry, and narrative content. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke creative-writing --request "Describe what you need"
```

### With Context

```
invoke creative-writing --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
