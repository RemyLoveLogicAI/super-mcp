...
Run interactive choose-your-own-adventure games with branching narratives.

## Description

Choose Your Adventure is a canonical Super-MCP skill that provides structured, repeatable capability for run interactive choose-your-own-adventure games with branching narratives. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke game-adventure --request "Describe what you need"
```

### With Context

```
invoke game-adventure --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
