...
Write engaging blog posts with proper structure, SEO, and formatting.

## Description

Blog Post Writer is a canonical Super-MCP skill that provides structured, repeatable capability for write engaging blog posts with proper structure, seo, and formatting. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke blog-post --request "Describe what you need"
```

### With Context

```
invoke blog-post --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
