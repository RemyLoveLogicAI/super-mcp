...
Generate names for projects, products, domains, and variables.

## Description

Name Generator is a canonical Super-MCP skill that provides structured, repeatable capability for generate names for projects, products, domains, and variables. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke name-generator --request "Describe what you need"
```

### With Context

```
invoke name-generator --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
