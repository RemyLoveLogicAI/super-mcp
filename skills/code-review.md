...
tool_dependencies:
  - github
  - gitlab
composable_with: ["code-generation", "code-refactor"]
...
Analyze code for quality, bugs, security issues, and style violations.

## Description

Code Review is a canonical Super-MCP skill that provides structured, repeatable capability for analyze code for quality, bugs, security issues, and style violations. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke code-review --request "Describe what you need"
```

### With Context

```
invoke code-review --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
