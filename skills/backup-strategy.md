...
tags: ["backup", "disaster-recovery", "strategy"]
---
...
Design backup and disaster recovery strategies for databases and systems.

## Description

Backup Strategy is a canonical Super-MCP skill that provides structured, repeatable capability for design backup and disaster recovery strategies for databases and systems. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke backup-strategy --request "Describe what you need"
```

### With Context

```
invoke backup-strategy --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
