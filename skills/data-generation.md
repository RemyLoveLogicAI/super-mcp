...
Generate realistic test data, fixtures, and seed data.

## Description

Data Generation is a canonical Super-MCP skill that provides structured, repeatable capability for generate realistic test data, fixtures, and seed data. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke data-generation --request "Describe what you need"
```

### With Context

```
invoke data-generation --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
