...
Generate spaced-repetition flashcards for learning technical material.

## Description

Flashcard Maker is a canonical Super-MCP skill that provides structured, repeatable capability for generate spaced-repetition flashcards for learning technical material. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke flashcard-maker --request "Describe what you need"
```

### With Context

```
invoke flashcard-maker --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
