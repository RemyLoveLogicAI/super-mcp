...
tags: ["presentation", "slides", "speak"]
---
...
Presentation Builder is a canonical Super-MCP skill that provides structured, repeatable capability for create structured presentation outlines with speaker notes. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke presentation-builder --request "Describe what you need"
```

### With Context

```
invoke presentation-builder --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
