...
Design, test, and optimize prompts for AI models.

## Description

Prompt Engineer is a canonical Super-MCP skill that provides structured, repeatable capability for design, test, and optimize prompts for ai models. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke prompt-engineer --request "Describe what you need"
```

### With Context

```
invoke prompt-engineer --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
