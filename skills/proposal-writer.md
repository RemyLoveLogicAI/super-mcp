...
Write project proposals, RFCs, and design documents.

## Description

Proposal Writer is a canonical Super-MCP skill that provides structured, repeatable capability for write project proposals, rfcs, and design documents. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke proposal-writer --request "Describe what you need"
```

### With Context

```
invoke proposal-writer --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
