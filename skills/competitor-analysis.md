...
tags: ["competitor", "market", "research"]
---
...
Research and compare competitor products, features, and market positioning.

## Description

Competitor Analysis is a canonical Super-MCP skill that provides structured, repeatable capability for research and compare competitor products, features, and market positioning. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke competitor-analysis --request "Describe what you need"
```

### With Context

```
invoke competitor-analysis --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
