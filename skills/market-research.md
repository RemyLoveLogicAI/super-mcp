...
tags: ["market", "trends", "competitive"]
---
...
Research market trends, sizing, and competitive landscape.

## Description

Market Research is a canonical Super-MCP skill that provides structured, repeatable capability for research market trends, sizing, and competitive landscape. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke market-research --request "Describe what you need"
```

### With Context

```
invoke market-research --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
