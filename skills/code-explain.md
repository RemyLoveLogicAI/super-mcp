...
Explain code logic, patterns, and design decisions in plain language.

## Description

Code Explanation is a canonical Super-MCP skill that provides structured, repeatable capability for explain code logic, patterns, and design decisions in plain language. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke code-explain --request "Describe what you need"
```

### With Context

```
invoke code-explain --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
