...
Add or improve type annotations and generate type stubs.

## Description

Type Annotation is a canonical Super-MCP skill that provides structured, repeatable capability for add or improve type annotations and generate type stubs. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke type-annotation --request "Describe what you need"
```

### With Context

```
invoke type-annotation --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
