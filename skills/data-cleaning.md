...
tags: ["clean", "normalize", "deduplicate"]
---
...
Clean, normalize, and deduplicate messy datasets.

## Description

Data Cleaning is a canonical Super-MCP skill that provides structured, repeatable capability for clean, normalize, and deduplicate messy datasets. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke data-cleaning --request "Describe what you need"
```

### With Context

```
invoke data-cleaning --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
