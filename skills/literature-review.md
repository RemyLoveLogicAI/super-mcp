...
Conduct systematic literature reviews on technical topics.

## Description

Literature Review is a canonical Super-MCP skill that provides structured, repeatable capability for conduct systematic literature reviews on technical topics. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke literature-review --request "Describe what you need"
```

### With Context

```
invoke literature-review --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
