...
Summarize long documents, articles, or conversations into concise briefs.

## Description

Content Summarizer is a canonical Super-MCP skill that provides structured, repeatable capability for summarize long documents, articles, or conversations into concise briefs. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke content-summarizer --request "Describe what you need"
```

### With Context

```
invoke content-summarizer --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
