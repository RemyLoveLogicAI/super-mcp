...
Design structured learning paths with resources and milestones.

## Description

Learning Path Designer is a canonical Super-MCP skill that provides structured, repeatable capability for design structured learning paths with resources and milestones. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke learning-path --request "Describe what you need"
```

### With Context

```
invoke learning-path --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
