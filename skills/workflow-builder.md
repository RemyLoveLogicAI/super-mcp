...
Design and generate automated workflows for business processes.

## Description

Workflow Builder is a canonical Super-MCP skill that provides structured, repeatable capability for design and generate automated workflows for business processes. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke workflow-builder --request "Describe what you need"
```

### With Context

```
invoke workflow-builder --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
