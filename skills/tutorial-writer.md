...
Write step-by-step tutorials with code examples and explanations.

## Description

Tutorial Writer is a canonical Super-MCP skill that provides structured, repeatable capability for write step-by-step tutorials with code examples and explanations. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke tutorial-writer --request "Describe what you need"
```

### With Context

```
invoke tutorial-writer --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
