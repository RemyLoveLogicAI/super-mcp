...
Audit software licenses for compatibility and compliance.

## Description

License Audit is a canonical Super-MCP skill that provides structured, repeatable capability for audit software licenses for compatibility and compliance. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke license-audit --request "Describe what you need"
```

### With Context

```
invoke license-audit --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
