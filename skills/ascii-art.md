...
Generate ASCII art, banners, and text decorations.

## Description

ASCII Art Generator is a canonical Super-MCP skill that provides structured, repeatable capability for generate ascii art, banners, and text decorations. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke ascii-art --request "Describe what you need"
```

### With Context

```
invoke ascii-art --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
