...
Conduct structured web research with source verification and citation.

## Description

Web Research is a canonical Super-MCP skill that provides structured, repeatable capability for conduct structured web research with source verification and citation. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke web-research --request "Describe what you need"
```

### With Context

```
invoke web-research --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
