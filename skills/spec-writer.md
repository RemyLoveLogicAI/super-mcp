...
Write detailed technical specifications and requirements documents.

## Description

Specification Writer is a canonical Super-MCP skill that provides structured, repeatable capability for write detailed technical specifications and requirements documents. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke spec-writer --request "Describe what you need"
```

### With Context

```
invoke spec-writer --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
