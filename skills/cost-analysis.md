...
Analyze cloud infrastructure costs and suggest optimization strategies.

## Description

Cost Analysis is a canonical Super-MCP skill that provides structured, repeatable capability for analyze cloud infrastructure costs and suggest optimization strategies. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke cost-analysis --request "Describe what you need"
```

### With Context

```
invoke cost-analysis --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
