...
Explain technical concepts at adjustable complexity levels.

## Description

Concept Explainer is a canonical Super-MCP skill that provides structured, repeatable capability for explain technical concepts at adjustable complexity levels. It integrates with the kernel's safety layer, event bus, and checkpoint system to ensure all operations are auditable and replayable.
...
```
invoke concept-explainer --request "Describe what you need"
```

### With Context

```
invoke concept-explainer --request "Specific task" --context '{"path": "/src", "lang": "python"}'
```
